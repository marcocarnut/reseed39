...
const STRINGS = {
  en: {
    ...
    benchCpuKdf: "CPU — PBKDF2 (1 core)", benchCpuSweep: "CPU — sweep (unrank+checksum)", benchGpuKdf: "GPU — seed kernel",
  ...
  pt: {
    ...
    benchCpuKdf: "CPU — PBKDF2 (1 núcleo)", benchCpuSweep: "CPU — varredura (unrank+checksum)", benchGpuKdf: "GPU — kernel de seed",
